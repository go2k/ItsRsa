...
//        publicKey  = new BigInteger("65537");     // common value in practice = 2^16 + 1
        publicKey  = new BigInteger("4294967297");     // value in practice = 2^32 + 1
//        publicKey  = new BigInteger("18446744078004518913");     // value in practice = 2^64 + 1
...
//        String s = "test";
        ...
        byte[] bytet = decrypt.toByteArray();
        String t = new String(bytet);
        
        System.out.println("orig. message = " + s);
        System.out.println("message  byte = " + message);
        System.out.println("encrypted     = " + encrypt);
        System.out.println("decrypted     = " + decrypt);
        System.out.println("decr. message = " + t);
